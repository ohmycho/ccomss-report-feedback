...
//
// '꼼즈 피드백' 도구용 — 수업 관찰 기록을 학부모용 카카오톡 메시지 초안으로 바꿔주는 함수.
...
exports.handler = async (event) => {
  ...
  const { brandName, student, session, start, action, quote, next, home } = payload;
...
4. 전체 3~4문장, 카카오톡으로 바로 보낼 수 있는 완성된 메시지 형태로 씁니다.
5. 이모지나 별표 같은 장식은 쓰지 않습니다.`;
